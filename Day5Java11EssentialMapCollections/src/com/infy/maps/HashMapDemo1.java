...
public class HashMapDemo1 {
	...
	public static void main(String[] args) {
		...
		for(String key:keys)
				System.out.println("Book : "+key+" available at shelf no :"+bookDetails.get(key));
		...
		// To check an existence of any key
		boolean res=bookDetails.containsKey("Satsang Sevak");
		System.out.println("Is Book Called ABC available in this map : "+res);
